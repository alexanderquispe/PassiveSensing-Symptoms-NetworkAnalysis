...
ssrs_wish <- selfreport_2018_2019 %>%
  select(UserID, Year, starts_with("ssrs_wish")) %>%
...
ssrs_kill <- selfreport_2018_2019 %>%
  select(UserID, Year, starts_with("ssrs_kill")) %>%
  filter(ssrs_kill0 == 1 | ssrs_kill1 == 1 | ssrs_kill2 == 1 | ssrs_kill3 == 1 | ssrs_kill4 == 1) 
